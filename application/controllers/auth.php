...
class Auth extends CI_Controller {
	...
	function __construct()
	{
        ...
        // Set Layout
        $this->template->set_layout('layouts/auth/layout');
        
        // Custom Theme CSS
        $this->template->add_css("assets/css/auth.css", "screen");        
	}
	...
	function create_user()
	{
		...
		$this->form_validation->set_rules('name', $this->lang->line('create_user_validation_name_label'), 'required|xss_clean');
	...
	function edit_user($id)
	{
		...
		//validate form input
		$this->form_validation->set_rules('name', $this->lang->line('edit_user_validation_name_label'), 'required|xss_clean');
